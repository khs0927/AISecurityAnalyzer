    ...
    <div className="pb-20">
      ...
      <div className="mb-6 flex justify-between items-center">
        <div className="mt-4 flex items-center">
          <img src={logoIcon} alt="낫투데이 로고" className="w-11 h-11 mr-0.5" />
          <h1 className="font-bold">
            <span className="text-[#D00000] text-4xl font-extrabold font-suite block mb-1">낫투데이</span>
            <span className="text-black text-xs font-suite tracking-wider block">ONE MORE LIFE</span>
          </h1>
        </div>
          ...
          <div className="flex justify-end items-center mb-1">
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span className="font-bold text-black">연결됨</span>
                ...
                <div className="relative" style={{ 
                  ...
                  {tab.imageUrl ? (
                    <img 
                      src={tab.imageUrl} 
                      alt={tab.label} 
                      className={`object-contain ${tab.id === "emergency-guide" || tab.id === "ai-consultation" ? "w-[4.5rem] h-[4.5rem]" : "w-16 h-16"}`}
                    />
                  ) : (
