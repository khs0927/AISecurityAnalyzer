...
const EmergencyGuideScreen = ({ webAppData, refreshData, loading }) => {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        {/* 웹 연동 정보 */}
        <View style={styles.webSyncContainer}>
          <Ionicons name="refresh-circle" size={20} color="#2196F3" />
          <Text style={styles.webSyncText}>
            웹 애플리케이션과 연동되어 최신 응급처치 정보를 제공합니다.
          </Text>
        </View>
        
        {/* 가이드 설명 */}
        <View style={styles.guideDescription}>
          <Text style={styles.guideTitle}>응급 상황별 대처법</Text>
          <Text style={styles.guideText}>
            상황에 맞는 응급처치 방법을 확인하세요. 음성 안내를 위해 항목을 선택하세요.
          </Text>
        </View>
